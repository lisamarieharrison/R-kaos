...
setwd(dir = "C:/Users/Lisa/Documents/phd/southern ocean/KAOS/exported_integrations_2km")

file.create("C:/Users/Lisa/Documents/phd/southern ocean/KAOS/kaos_combined_density_intervals_2km.csv")

#get dates of files in folder
survey.dates <- as.numeric(substr(list.files(path = "C:/Users/Lisa/Documents/phd/southern ocean/KAOS/exported_integrations_2km", pattern = paste("(", "38kHz", ").*\\.csv$", sep = ""), full.names = F), start = 24, stop = 31))
