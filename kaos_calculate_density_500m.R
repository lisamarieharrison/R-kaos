...
setwd(dir = "C:/Users/Lisa/Documents/phd/southern ocean/KAOS data/exported_integrations_500m")
...
for (i in 1:length(survey.dates)) {
  ...
  write.table(dat, file = "C:/Users/Lisa/Documents/phd/southern ocean/KAOS data/kaos_combined_density_intervals_500m.csv", row.names = F, col.names = F, sep = ",", append = TRUE)
