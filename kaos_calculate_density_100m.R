...
for (i in 1:length(survey.dates)) {
  ...
  #remove values at less than 100m depth (maximum adelie penguin foraging depth)
  acoustic_38 <- acoustic_38[acoustic_38$Layer <= 19, ]
  acoustic_120 <- acoustic_120[acoustic_120$Layer <= 19, ]  
  ...
  write.table(dat, file = "C:/Users/Lisa/Documents/phd/southern ocean/KAOS data/kaos_combined_density_intervals_100m.csv", row.names = F, col.names = F, sep = ",", append = TRUE)
