...
for (i in 1:length(file.dates)) {
  ...
  return.file.38 <- paste("C:/Users/Lisa/Documents/phd/southern ocean/KAOS data/exported_integrations_500m/kaos_38kHz_integration_", file.dates[i], ".csv", sep = "")
  return.file.120 <- paste("C:/Users/Lisa/Documents/phd/southern ocean/KAOS data/exported_integrations_500m/kaos_120kHz_integration_", file.dates[i], ".csv", sep = "")
