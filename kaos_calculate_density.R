...
dat <- read.csv("C:/Users/Lisa/Documents/phd/southern ocean/KAOS/kaos_combined_density_intervals.csv", header = T)
dat$interval_length[dat$interval_length > 50000] <- 0
dat$p[dat$p > 5000] <- NA
